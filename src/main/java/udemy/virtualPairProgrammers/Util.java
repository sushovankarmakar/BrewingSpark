 ...
 * <p>
 * Words that appear in every single course must (we think) be "boring" - i.e., they don't have a relevance
 * to just one specific course.
 * <p>
 * This list of words is "small data" - i.e., it can be safely loaded into the driver's JVM - no need to
...
public class Util {
    ...
    /**
     * Returns true if we think the word is "boring" - i.e., it doesn't seem to be a keyword
